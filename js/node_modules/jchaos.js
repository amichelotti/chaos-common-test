...
(function () {
	function createLibrary() {
	    ...
	    console.log("Starting jchaos.js Library (andrea.michelotti@lnf.infn.it) ");
	    console.log("Server:"+process.env.WEBUI_SERVER);
	    if (process.env.hasOwnProperty('WEBUI_SERVER')){
			...
			jchaos.getChannel(devlist, -1, function (ds) {
				...
				ds.forEach(function (elem) {
					if (elem.hasOwnProperty("health") && elem.health.hasOwnProperty("ndk_uid")) {
						if (checkFunc(elem)) {
							tot_ok++;
							console.log("\x1B[1m" + str + "\x1B[1m\t\x1B[32m\x1B[1mOK\x1B[22m\x1B[39m \x1B[1m" + elem.health.ndk_uid + "\x1B[22m ("+elem.health.nh_status+") " + tot_ok + "/" + devlist.length);

						} else {
							if (retry > 1) {
								console.log("\x1B[1m" + str + "\x1B[1m\t-" + retry + "- \x1B[33m\x1B[1m" + elem.health.ndk_uid + "\x1B[22m\x1B[39m ("+elem.health.nh_status+") " + tot_ok + "/" + devlist.length);
							} else {
								console.log("\x1B[1m" + str + "\x1B[1m\t-" + retry + "- \x1B[31m\x1B[1m" + elem.health.ndk_uid + "\x1B[22m\x1B[39m ("+elem.health.nh_status+") " + tot_ok + "/" + devlist.length);
							}
						}
					} else {
						if (retry > 1) {
