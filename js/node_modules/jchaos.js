						...
						if (custate != "" && (state != custate)) {
							...
							if (state == "Start") {
								switch (custate) {
									case "Stop":
									case "Init":
										jchaos.sendCUCmd(cuname, "start", "", null);
										break;
									case "Deinit":
								...
								switch (custate) {
									case "Start":
										jchaos.sendCUCmd(cuname, "stop", "", null);
										break;
									case "Deinit":
								...
								switch (custate) {
									case "Stop":
										jchaos.sendCUCmd(cuname, "deinit", "", null);
										break;
									case "Init":
										jchaos.sendCUCmd(cuname, "deinit", "", null);
										break;
								...
								switch (custate) {
									case "Stop":
										jchaos.sendCUCmd(cuname, "deinit", "", function (handleFunc) {
											jchaos.sendCUCmd(cuname, "init", "", null);
										});
										break;
									case "Deinit":
										jchaos.sendCUCmd(cuname, "init", "", null);
...
//			console.log(" checking Live of " + devlist + " every:" + checkFreq + " ms");
			...
			devlist.forEach(function (elem) {
				jchaos.getChannel(elem, -1, function (data) {
					...
					if (checkFunc(data[0])) {
						tot_ok++;
						console.log("\t- " + data[0].health.ndk_uid + " OK status:\""+ data[0].health.nh_status+"\" ETA:" + tot_ok + "/" + devlist.length);
					} else {
						console.log("\t% " + data[0].health.ndk_uid + " OK status:\""+ data[0].health.nh_status+"\" ETA:" + tot_ok + "/" + devlist.length);
					}
